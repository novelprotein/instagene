...
Benchmarks require the `instagene.perf=true` system property (set automatically
when using the `bench` task). Each operation is measured 3 times and the minimum
time is reported.
