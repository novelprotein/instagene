 ...
 * (`.instagene/` hidden), labelled by its path relative to the project,
 * double-click to open, right-click for "open in folder" / "open with system
 * app". Files already open in a tab are shown bold. With no project attached
 * the tree shows a hint instead.
 */
class ProjectTreePanel(
    ...
    /**
     * Re-reads the project folder and the open-file set from the current state,
    ...
    private fun treePath(node: DefaultMutableTreeNode): javax.swing.tree.TreePath {
