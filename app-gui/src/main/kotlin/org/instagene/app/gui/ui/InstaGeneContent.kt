...
import org.instagene.app.gui.doc.Openers
...
class InstaGeneContent(
     ...
     * margins and no divider. The split's resize weight stays at zero in both
     * states so window resizing changes the editor width while the browser
     * keeps its current pixel width; the header toggle restores it.
     */
