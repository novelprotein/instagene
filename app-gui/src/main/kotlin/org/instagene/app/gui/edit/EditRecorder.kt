...
/**
 * Records the current project's edit history and writes each completed entry
 * immediately to `<project>/.instagene/history.json`.
 *
...
class EditRecorder(
    ...
    /** Appends [entry], trims to [historyLimit], and immediately persists the result. */
