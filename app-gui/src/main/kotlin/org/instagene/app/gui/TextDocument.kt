 ...
 * undoable, mirroring [SeqDocument]'s history stack; the dirty flag compares
 * against the last saved or loaded state.
 */
class TextDocument(initial: String = "", override var file: File? = null) : Doc {
    ...
    /** The text as of the last save/load: the baseline [isDirty] is compared against. */
